...
#ifndef ADDED_METADATA_H
#define ADDED_METADATA_H
char * Metadata_Get_LastString ();
void Metadata_Free_LastString();
SO_PUBLIC extern bool Metadata_Get_Filename  (struct List *list, uint32_t *len, const char **string);
#endif
...
// #define Metadata_Add NTLVList_Add
//SO_PUBLIC extern bool Metadata_Add (struct List *list, uuid_t name, uuid_t type, uint32_t size, const uint8_t * data);
